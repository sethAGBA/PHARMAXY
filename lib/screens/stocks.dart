...
//   Widget _marginBanner(ThemeColors palette, double percent, double value, Color accent) {
//     final color = percent >= 0 ? accent : Colors.red;
...
//           borderRadius: BorderRadius.circular(12),
//           border: Border.all(color: active ? accent : palette.divider),
//         ),
//         child: Text(
//           label,
//           style: TextStyle(
